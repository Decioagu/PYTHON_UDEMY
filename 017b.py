...
class Fabricante:
    ...
    @property # getter (carros)
    def modelo_carro(self):
        for carro in self.lista_carro_e_motores:
            print('Fabricante:', self.nome_fabricante, ', Carro:',*carro) 

    @modelo_carro.setter # setter (carros)
    def modelo_carro(self, carro_e_motores):
        self.lista_carro_e_motores.append(carro_e_motores)
