...
arquivo = open('texto_b.txt', 'w', encoding='utf8') # Abre o arquivo "myfile.txt" para leitura
arquivo.writelines(
'''
Prezado(a) ${nome},
...
CAMINHO_ARQUIVO = Path(__file__).parent / 'texto_b.txt' # caminho do arquivo
